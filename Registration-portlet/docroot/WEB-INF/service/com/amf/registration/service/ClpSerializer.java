...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(EventMonitorClp.class.getName())) {
			return translateInputEventMonitor(oldModel);
		}
	...
	public static Object translateInputEventMonitor(BaseModel<?> oldModel) {
		EventMonitorClp oldClpModel = (EventMonitorClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getEventMonitorRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.amf.registration.model.impl.EventMonitorImpl")) {
			return translateOutputEventMonitor(oldModel);
		}
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.amf.registration.NoSuchEventMonitorException")) {
			return new com.amf.registration.NoSuchEventMonitorException();
		}
	...
	public static Object translateOutputEventMonitor(BaseModel<?> oldModel) {
		EventMonitorClp newModel = new EventMonitorClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setEventMonitorRemoteModel(oldModel);
