...
public class AddressLocalServiceWrapper implements AddressLocalService,
	...
	*/
	...
	public com.amf.registration.model.Address addAddress(long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _addressLocalService.addAddress(userId, address1, address2,
			city, state, zip, serviceContext);
	}

	public int countByZip(java.lang.String zip)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _addressLocalService.countByZip(zip);
	}

	public java.util.List findByZip(java.lang.String zip, int start, int end)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _addressLocalService.findByZip(zip, start, end);
	}
